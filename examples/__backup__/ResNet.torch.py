...
class ResNet(nn.Module):
    def __init__(self, num_channels=3, num_classes=10, num_layers=18, kernel_size=7, stride=2, padding=3):
        name = "resnet"+str(num_layers)
        if(model_urls[name] == None):
            name="resnet18"
        ...
        self.conv1 = nn.Conv2d(num_channels, 64, kernel_size=kernel_size, stride=stride, padding=padding, bias=False)
